...
- Dashboard webhooks rejected with 401 (wrong secret) were still not redelivered 15 minutes later. Svix backs off to minutes and then hours, so a wrong secret costs that bot's whole status timeline; the fresh end of call events arrived fine once the secret was right.
